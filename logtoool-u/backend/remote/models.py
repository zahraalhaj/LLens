...
class RemoteMachineModel(Base):
    ...
    encrypted_secret = Column(Text, nullable=False)  # encrypted password OR encrypted private key
    ...
    last_status = Column(String, nullable=True)  # 'success' | 'error' | None (never polled)
