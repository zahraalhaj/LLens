...
from backend.analysis.debit_portal import DEFAULT_SOURCE_SYSTEM, compute_debit_portal_summary
from backend.api.deps import get_current_user, get_db
from backend.auth.service import AuthenticatedUser
from backend.core.store import DatabaseManager

router = APIRouter(prefix="/api/debit-portal", tags=["debit-portal"])
...
def summary(
    ...
    return compute_debit_portal_summary(events)
