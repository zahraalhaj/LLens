...
from backend.analysis.vflex import DEFAULT_SOURCE_SYSTEM, compute_vflex_summary
...
router = APIRouter(prefix="/api/vflex", tags=["vflex"])
...
def summary(
    ...
    return compute_vflex_summary(events)
